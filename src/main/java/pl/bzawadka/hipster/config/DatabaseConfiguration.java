package pl.bzawadka.hipster.config;

import pl.bzawadka.hipster.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("pl.bzawadka.hipster.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("pl.bzawadka.hipster.repository.search")
